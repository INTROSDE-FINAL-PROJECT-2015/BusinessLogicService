 ...
 *
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://ws.mail.introsde/", wsdlLocation = "https://cryptic-mountain-16475.herokuapp.com/ws/mail?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://ws.mail.introsde/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://cryptic-mountain-16475.herokuapp.com/ws/mail?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://ws.mail.introsde/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mail.introsde/", "MailServiceImplPort"), MailService.class, features);
    }
