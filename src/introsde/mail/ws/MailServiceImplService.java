 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://ws.mail.introsde/", wsdlLocation = "http://localhost:6901/ws/mail?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6901/ws/mail?wsdl");
